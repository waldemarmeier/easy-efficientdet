...
class PerImageEvaluation(object):
    ...
    """
        if (detected_masks is not None
                and groundtruth_masks is None) or (detected_masks is None
                                                   and groundtruth_masks is not None):
            raise ValueError(
        ...
        for i in range(self.num_groundtruth_classes):
            (gt_boxes_at_ith_class, gt_masks_at_ith_class, detected_boxes_at_ith_class,
             detected_scores_at_ith_class,
             detected_masks_at_ith_class) = self._get_ith_class_arrays(
                 detected_boxes, detected_scores, detected_masks, detected_class_labels,
                 groundtruth_boxes, groundtruth_masks, groundtruth_class_labels, i)
    ...
    """
      ...
      """
            ...
            for i in range(num_detected_boxes):
                ...
                is_evaluatable = (not tp_fp_labels[i] and not is_matched_to_difficult[i]
    ...
    def _get_ith_class_arrays(self, detected_boxes, detected_scores, detected_masks,
                              detected_class_labels, groundtruth_boxes,
                              groundtruth_masks, groundtruth_class_labels, class_index):
