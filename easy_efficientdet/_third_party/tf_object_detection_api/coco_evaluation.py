...
class CocoDetectionEvaluator(object_detection_evaluation.DetectionEvaluator):
    ...
    def add_eval_dict(self, eval_dict):
        ...
        def update_op(image_id_batched, groundtruth_boxes_batched,
            ...
            for (image_id, gt_box, gt_class, gt_is_crowd, gt_labeled_classes,
                 num_gt_box, det_box, det_score,
                 det_class, num_det_box, is_annotated) in zip(
        ...
        num_gt_boxes_per_image = eval_dict.get(input_data_fields.num_groundtruth_boxes,
                                               None)
        ...
        if groundtruth_labeled_classes is None:
            groundtruth_labeled_classes = tf.reduce_max(tf.one_hot(
        ...
        return tf.py_func(update_op, [
            ...
            detection_scores, detection_classes, num_det_boxes_per_image, is_annotated
        ], [])
    ...
    """
        ...
        metric_names = [
            ...
            'DetectionBoxes_Precision/mAP (small)', 'DetectionBoxes_Recall/AR@1',
