...
"""
"""
    Tensorflow efficientnet implementation adjusted for multi-GPU training
    by replacing BatchNorm-layers with SyncBatchNorm.
"""
# flake8: noqa E402
import copy
import math
...
def EfficientNet(width_coefficient,
  ...
  """
    ...
    x = SyncBatchNormalization(axis=bn_axis, name='stem_bn')(x)
    ...
    x = SyncBatchNormalization(axis=bn_axis, name='top_bn')(x)
...
def block(inputs,
  ...
  """
    ...
    if expand_ratio != 1:
        ...
        x = SyncBatchNormalization(axis=bn_axis, name=name + 'expand_bn')(x)
    ...
    x = SyncBatchNormalization(axis=bn_axis, name=name + 'bn')(x)
    ...
    x = SyncBatchNormalization(axis=bn_axis, name=name + 'project_bn')(x)
